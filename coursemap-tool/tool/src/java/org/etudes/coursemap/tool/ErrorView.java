/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/coursemap/trunk/coursemap-tool/tool/src/java/org/etudes/coursemap/tool/ErrorView.java $
 * $Id: ErrorView.java 1539 2011-05-28 22:44:25Z ggolden $
 ***********************************************************************************
 *
...
/**
 * The /error view for the course map tool.
 */
public class ErrorView extends ControllerImpl
{
	...
	{
		// we would like a single parameter (error code)
